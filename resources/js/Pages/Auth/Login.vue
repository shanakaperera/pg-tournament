    ...
    <div class="w-full max-w-md">
      <form class="mt-8 bg-white rounded-lg shadow-xl overflow-hidden" @submit.prevent="login">
        <div class="px-10 py-12">
          <h1 class="text-center font-bold text-3xl">Pokerguild Tournament</h1>
          <div class="mx-auto mt-6 w-24 border-b-2" />
          <text-input v-model="form.id" :error="form.errors.id" class="mt-10" label="ID" type="text" autofocus autocapitalize="off" />
